package ru.digitalhabbits.kafka.consumer;
...
public class KafkaConsumerApplication {
    ...
    private static final String TOPIC_NAME = "spring-test-topic";
    ...
    public void listener(@Payload String message, @Header(KafkaHeaders.RECEIVED_PARTITION_ID) int partition) {
        logger.info("Received message (partition {}): '{}'", partition, message);
    }
}
